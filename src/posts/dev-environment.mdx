...
some UNIX wizards use [asdf](https://asdf-vm.com/) or similar tools (sorry for windows users) and this one does
...
For java/kotlin users (aren't we all?) there is
[SDKMAN](https://sdkman.io/) but it doesnt like windows much
